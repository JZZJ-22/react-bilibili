...
const RoutesConfig = () => {
  ...
  return (
    <Routes>
      ...
      <Route path='/home/mail-box' element={<MailBox />}/>  // 首页邮箱
      <Route path="/dynamic" element={<Dynamic />}/>  // 动态
      <Route path="/vip" element={<Vip />}/>  // 会员购
      <Route path="/vip/search" element={<VipSearch />}/>  // 会员购搜索页面
      <Route path='/vip/shopping-cart' element={<ShoppingCart />}/>  // 会员购购物车
      <Route path='/vip/good/:id' element={<GoodDetail />}/>  // 会员购商品详情页
      <Route path="/mine" element={<Mine />}/>  // 我的
      <Route path='/mine/collect' element={<Collect />}/>  // 我的收藏
      <Route path='/mine/wait' element={<Wait />}/>  // 稍后再看
      <Route path='/mine/space' element={<Space />}/>  // 我的空间
      <Route path='/mine/edit' element={<Edit />}/>  // 个人信息编辑页
